    ...
    public static void main(String args[]) {
        try {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                if (i < 4) {
                    solver.addToA(i, i + 1, -0.5);
                    solver.addToA(i + 1, i, -0.5);
                }
            }

            solver.addToA(0, 4, -0.5);
            solver.addToA(4, 0, -0.5);
            ...
            solver.addToA(5, 9, -0.5);
            solver.addToA(9, 5, -0.5);
            ...
            solver.addToA(10, 14, -0.5);
            solver.addToA(14, 10, -0.5);            
            ...
            solver.addToB(17, 0, 0.5);
            solver.addToB(17, 1, 0.5);
            ...
            solver.addToB(20, 0, 5.5);
            solver.addToB(20, 1, 0.5);
            ...
            solver.addToB(23, 0, 5.5);
            solver.addToB(23, 1, 5.5);
